...
public class RippleBackground extends RelativeLayout{
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        rippleInnerColor = typedArray.getColor(R.styleable.RippleBackground_rb_innerColor, getResources().getColor(R.color.rippelfixColor));
        typedArray.recycle();
    ...
    private class RippleView extends View{
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if(rippleType == 1){
                ...
                innerPaint.setColor(rippleInnerColor);
                canvas.drawCircle(radius,radius,radius-rippleStrokeWidth,innerPaint);
            }
